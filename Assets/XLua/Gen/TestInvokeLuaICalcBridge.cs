...
{
    public class TestInvokeLuaICalcBridge : LuaBase, TestInvokeLua.ICalc
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new TestInvokeLuaICalcBridge(reference, luaenv);
		}
		
		public TestInvokeLuaICalcBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
