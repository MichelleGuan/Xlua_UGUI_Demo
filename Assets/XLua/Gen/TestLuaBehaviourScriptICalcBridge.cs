...
{
    public class TestLuaBehaviourScriptICalcBridge : LuaBase, TestLuaBehaviourScript.ICalc
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new TestLuaBehaviourScriptICalcBridge(reference, luaenv);
		}
		
		public TestLuaBehaviourScriptICalcBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
