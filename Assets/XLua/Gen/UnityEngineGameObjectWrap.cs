    ...
    public class UnityEngineGameObjectWrap 
    {
        ...
        static int _m_AddMissingComponent(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Type cmpType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                    
                        UnityEngine.Component __cl_gen_ret = __cl_gen_to_be_invoked.AddMissingComponent( cmpType );
                        translator.Push(L, __cl_gen_ret);
