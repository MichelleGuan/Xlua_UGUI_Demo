...
{
    public class TextXLuaICalcBridge : LuaBase, TextXLua.ICalc
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new TextXLuaICalcBridge(reference, luaenv);
		}
		
		public TextXLuaICalcBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
